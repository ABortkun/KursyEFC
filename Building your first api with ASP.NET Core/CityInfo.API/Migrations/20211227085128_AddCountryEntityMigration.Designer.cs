...
namespace CityInfo.API.Migrations
{
    ...
    [Migration("20211227085128_AddCountryEntityMigration")]
    partial class AddCountryEntityMigration
    {
            ...
            modelBuilder.Entity("CityInfo.API.Entities.City", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Country = "United States of America", Description = "The one with that big park.", Name = "New York City" },
                        new { Id = 2, Country = "Belgium", Description = "The one with the cathedral that was never really finished.", Name = "Antwerp" },
                        new { Id = 3, Country = "France", Description = "The one with that big tower.", Name = "Paris" },
                        new { Id = 4, Country = "Poland", Description = "Big part of Tri-City with acces to the sea", Name = "Gdańsk" },
                        new { Id = 5, Country = "Poland", Description = "The one with that big tower.", Name = "Warszawa" }
                    );
                });
